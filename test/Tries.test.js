...
describe("Word inserted to Trie", () => {
  ...
  it("should add word 'and' ", () => {
    ...
    expect(myTrie.root.children.a.children.n.children).to.eql({
      d: { key: "d", children: {}, end: true }
    });
  });
  it("should add word 'be' ", () => {
    let myTrie = new Trie();
    myTrie.insert("be");
    expect(myTrie.root.children.b.children).to.eql({
      e: { key: "e", children: {}, end: true }
    });
  });
});
...
describe("Contains function", () => {
  it("should return boolean for if work exists in trie", () => {
    ...
    expect(myTrie.root.children.a.children.n.children.n.children).to.eql({
      a: { key: "a", children: {}, end: true }
    });
...
=======
    ...
    expect(myTrie.contains("ann")).to.eql(true);
    expect(myTrie.contains("and")).to.eql(true);
>>>>>>> 1a272571227581ab69f32b02bcca24f6c81a7cf1
  });
});
